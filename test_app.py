#!/usr/bin/env python3
"""
Suite de Pruebas - Servidor Flask (Interestelar)
==================================================

Pruebas del servidor web del motor de búsqueda semántica local
usando el test client de Flask (sin levantar el servidor real).
...
class InterestelarAppTestCase(unittest.TestCase):
    ...
    def test_index_ok(self):
        ...
        self.assertIn('INTERESTELAR'.encode(), resp.data)
